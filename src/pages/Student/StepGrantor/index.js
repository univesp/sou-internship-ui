...
class StepGrantor extends Component {
  ...
  render() {
    const {
      ...
      handleSubmit,
      buttons,
      initialValues: { grantorSelected, instituition, responsible, regent, advisor },
      saveChanges
    } = this.props;
      ...
      {({ setFieldValue, values, handleBlur }) => (
        ...
        <Row>
          <Col width="22%">
            <Label>
              ...
              <Field
                ...
                render={({field}) => (
                  <InputMask {...field} mask="99.999.999/9999-99" maskChar={null} onBlur={e => {
                    field.onBlur(e);
                    saveChanges(values);
                  }} />
                )}
          ...
          <Col>
            <Label>
              Nome<span>*</span>
              <Field name="instituition.name" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          <Col>
            <Label>
              ...
              <Field name="instituition.street" onBlur={e => {
                      handleBlur(e);
                      saveChanges(values);
                    }} />
              <ErrorMessage
          ...
          <Col width="35%">
            <Label>
              Complemento
              <Field name="instituition.complement" onBlur={e => {
                      handleBlur(e);
                      saveChanges(values);
                    }} />
            </Label>
          ...
          <Col width="30%">
            <Label>
              Cidade<span>*</span>
              <Field name="instituition.city" onBlur={e => {
                      handleBlur(e);
                      saveChanges(values);
                    }} />
              <ErrorMessage
          ...
          <Col width="8%">
            <Label>
              UF<span>*</span>
              <Field name="instituition.federatedState" onBlur={e => {
                      handleBlur(e);
                      saveChanges(values);
                    }} />
              <ErrorMessage
        ...
        <Row>
          <Col>
            <Label>
              ...
              <span>*</span>
              <Field name="responsible.name" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          ...
          <Col>
            <Label>
              ...
              <Field name="responsible.email" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          <Col>
            <Label>
              ...
              <Field name="regent.name" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          ...
          <Col>
            <Label>
              E-mail institucional <span>*</span>
              <Field name="regent.email" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          <Col>
            <Label>
              ...
              <Field name="advisor.name" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          <Col>
            <Label>
              ...
              <Field name="advisor.department" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }} />
              <ErrorMessage
        ...
        <Row>
          ...
          <Col>
            <Label>
              E-mail institucional <span>*</span>
              <Field name="advisor.email" onBlur={e => {
                    handleBlur(e);
                    saveChanges(values);
                  }}/>
              <ErrorMessage
